...
class SynchronizedArrayListTest extends ListTest {
  List<Integer> containerInitializer() {
    return Collections.synchronizedList(
      new ArrayList<Integer>((Collection<? extends Integer>) new CountingIntegerList(containerSize)));
  }
...
class CopyOnWriteArrayListTest extends ListTest {
  List<Integer> containerInitializer() {
    return new CopyOnWriteArrayList<Integer>((Collection<? extends Integer>) new CountingIntegerList(containerSize));
  }
